...
namespace PawnPlus
{
    class CodeCompletionDataProvider : AbstractCompletionDataProvider, IDisposable // With 'IDisposable' it will avoid warning generated by Code Analysis.
    {
        ...
        public override ICompletionData[] GenerateCompletionData(string fileName, TextArea textArea, char charTyped)
        {
            ...
            foreach (KeyValuePair<string, MethodInformations> CodeCompletion in Program.main.MethodsList)
            {
