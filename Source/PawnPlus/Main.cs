...
namespace PawnPlus
{
    public partial class Main : Form
    {
        ...
        public void OpenFile(string FilePath)
        {
            ...
            {
                string FileName = Path.GetFileName(FilePath), FileText = Encoding.GetEncoding("windows-1251").GetString(File.ReadAllBytes(FilePath));
        ...
        {
            File.WriteAllText(Path, this.CodeEditors[Path].CodeBox.Document.TextContent, Encoding.GetEncoding("windows-1251"));
